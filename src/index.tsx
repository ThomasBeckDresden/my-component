...
import { MyComponentProps, MyComponent } from "./my-component";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
   ...
   */
  return class MyComponentBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): MyComponentProps {
      const attrs = this.parseAttributes<MyComponentProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<MyComponent {...this.props} />, container);
    }
